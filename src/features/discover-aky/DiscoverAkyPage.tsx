...
const aboutItems = [
  ...
  },
  {
    icon: BrainCircuit,
    title: "Bazat pe RAG",
    description: "Combină generarea AI cu recuperarea informației relevante din sursele academice.",
    accent: true,
  },
]
...
export default function DiscoverAkyPage() {
  return (
    <AppShell
      title="Descoperă Aky"
      description="Aky este asistentul AI al Akadion, creat pentru a te ajuta să înțelegi, organizezi și recapitulezi mai eficient materialele academice."
      eyebrow="Asistent AI"
      ...
      <section className="grid gap-5 xl:grid-cols-2 xl:items-stretch">
        <Card className="rounded-[1.75rem] border-[#e4d8cd] bg-white shadow-[0_18px_48px_rgba(32,46,84,0.08)] xl:h-full">
          <CardHeader className="px-6 pb-3 pt-6">
            ...
            <CardDescription className="text-sm leading-7 text-slate-600">
              Aky este asistentul AI integrat în Akadion. Poate utiliza materialele academice disponibile pentru a oferi explicații, clarificări și suport pentru recapitulare.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex h-full flex-col gap-3 px-6 pb-6 pt-1">
            {aboutItems.map(({ icon: Icon, title, description, accent }) => (
        ...
        <Card className="rounded-[1.75rem] border-[#e4d8cd] bg-white shadow-[0_18px_48px_rgba(32,46,84,0.08)] xl:h-full">
          <CardHeader className="px-6 pb-3 pt-6">
            ...
            <CardDescription className="text-sm leading-7 text-slate-600">
              Funcționalități construite pentru a face studiul mai clar, mai rapid și mai bine organizat.
            </CardDescription>
          </CardHeader>
